...
window.SiteFlowI18n = (function () {
  ...
  const T = {
    es: {
      ...
      hero: {
        ...
        hfc4: 'Backup diario',
        badge: 'Diseño · Dominio · Hosting · Mantenimiento',
        title1: 'Tu negocio merece',
        title2: 'una web que venda por ti.',
        sub: 'Diseñamos, publicamos y cuidamos tu página web. Tú te ocupas de tu negocio. Nosotros del resto.',
        ctaWa: 'Quiero mi página',
        ctaPlans: 'Ver proyectos',
        stat1: 'Páginas web',
        stat2: '% satisfacción',
        stat3: '% compromiso',
      ...
      sequence: {
        web: 'UNA WEB.',
        everything: 'TODO LO QUE NECESITA.',
        connected: 'TODO CONECTADO.',
        onePlace: 'TODO EN UN SOLO LUGAR.',
        play: 'Ver animación',
        stop: 'Detener'
      },
      included: {
        title: 'Una web.<br><span>Todo incluido.</span>',
        sub: 'Una sola solución conecta lo que antes estaba repartido entre varios proveedores.',
        core: 'UNA SOLA SOLUCIÓN',
        design: 'DISEÑO',
        domain: 'DOMINIO',
        hosting: 'HOSTING',
        ...
        support: 'SOPORTE',
        designDesc: 'A medida',
        domainDesc: 'Desde el día uno',
        hostingDesc: '99.9% uptime',
        sslDesc: 'Certificado activo',
        maintenanceDesc: 'Actualizaciones incluidas',
        supportDesc: 'Personas reales',
        word1: 'CREATIVO',
        word2: 'CONECTADO',
        word3: 'RÁPIDO',
        word4: 'SEGURO',
        word5: 'Siempre<br>activo',
        word6: 'ACOMPAÑADO',
        outro: 'Todo<br>conectado.'
      },
      transformation: {
        heading: 'Sin SiteFlow y con SiteFlow',
        without: 'SIN SITEFLOW',
        chaos: 'TODO SEPARADO.',
        slow: 'LENTA',
        old: 'DESACTUALIZADA',
        noSupport: 'SIN SOPORTE',
        separate: 'HOSTING SEPARADO',
        problems: 'PROBLEMAS',
        with: 'CON SITEFLOW',
        resolved: 'TODO CONECTADO.',
        fast: 'RÁPIDA',
        secure: 'SEGURA',
        professional: 'PROFESIONAL',
        maintained: 'MANTENIDA',
        generic: 'PLANTILLA GENÉRICA',
        noBackup: 'SIN RESPALDOS',
        adv1: 'Carga en menos de 2 segundos',
        adv2: 'Diseño propio, sin plantillas',
        adv3: 'Hosting y dominio incluidos',
        adv4: 'SSL, backups y monitoreo',
        adv5: 'Actualizaciones cada mes',
        adv6: 'Soporte real que responde'
      },
      portfolio: {
        title: 'Trabajo que se<br><span>hace notar.</span>',
        sub: 'Proyectos reales, publicados y en producción. Entra y compruébalo tú mismo.',
        visit: 'Ver sitio',
        t1: 'PLATAFORMA QR',
        t2: 'E-COMMERCE',
        t3: 'SITIO DE SERVICIOS',
        t4: 'SITIO CORPORATIVO',
        t5: 'SITIO B2B',
        p1: 'Menova',
        p2: 'Oasis Piercing',
        p3: 'ASISTMED',
        p4: 'GO Solutions',
        p5: 'Kannabyte',
        d1: 'Carta QR, sala en vivo y cocina conectadas en un solo panel para restaurantes.',
        d2: 'Catálogo de joyería corporal con carrito y pedidos directos por WhatsApp.',
        d3: 'Salud a domicilio en Medellín: servicios, cobertura y contacto directo por WhatsApp.',
        d4: 'Sitio corporativo de software a medida, con servicios, productos y cotización.',
        d5: 'Sitio B2B de exportación medicinal: productos, calidad, licencias y contacto comercial.'
      },
      benefits: {
        eyebrow: 'El problema',
      ...
      process: {
        ...
        s4t: 'Publicamos y cuidamos tu web.',
        s4p: 'Tu web va live y nosotros la cuidamos cada mes para que nunca pare de funcionar.'
      },
      pricing: {
        eyebrow: 'Planes',
        title: 'Creación + cuidado.<br><span>Sin letra pequeña.</span>',
        sub: 'Sin contratos anuales obligatorios. Cancela cuando quieras.',
        currencyAria: 'Seleccionar moneda',
        setupPeriod: 'pago único',
        includesPlan: 'Incluye el plan',
        maintHeading: 'Mantenimiento',
        maintPeriod: '/mes',
        maintCustom: '/mes a cotizar',
        period: '/mes',
        popular: 'Más popular',
        basic: 'Básico',
        pro: 'Profesional',
      ...
      infrastructure: {
        title: 'Lo que no ves<br><span>también importa.</span>',
        sub: 'Tu web funciona sobre una base preparada para mantenerse rápida, segura y acompañada.',
        operational: 'OPERATIVO'
      },
      infrastructure: {
        title: 'What you cannot see<br><span>matters too.</span>',
        sub: 'Your website runs on a foundation designed to stay fast, secure and supported.',
        operational: 'OPERATIONAL'
      },
      infrastructure: {
        title: 'Was Sie nicht sehen,<br><span>ist ebenso wichtig.</span>',
        sub: 'Ihre Website läuft auf einer Basis, die schnell, sicher und betreut bleibt.',
      ...
      contact: {
        eyebrow: 'Contacto',
        title: '¿Hacemos algo<br><span>increíble?</span>',
        sub: 'Cuéntanos qué necesita tu negocio.',
      ...
      footer: {
        ...
        c3: 'Proyectos',
        c4: 'FAQ',
        copy: '© 2026 SiteFlowCol. Todos los derechos reservados.',
        legal: 'Aviso legal',
        privacy: 'Privacidad'
      },
      wa: {
    ...
    en: {
      ...
      hero: {
        ...
        hfc4: 'Daily backup',
        badge: 'Design · Domain · Hosting · Maintenance',
        title1: 'Your business deserves',
        title2: 'a website that sells for you.',
        sub: 'We design, publish and care for your website. You run your business. We handle the rest.',
        ctaWa: 'I want my website',
        ctaPlans: 'View projects',
      ...
      sequence: {
        web: 'ONE WEBSITE.',
        everything: 'EVERYTHING IT NEEDS.',
      ...
      included: {
        title: 'One website.<br><span>Everything included.</span>',
        sub: 'One solution connects what used to be split across multiple providers.',
        core: 'ONE SOLUTION',
        design: 'DESIGN',
        domain: 'DOMAIN',
        hosting: 'HOSTING',
        ...
        support: 'SUPPORT',
        designDesc: 'Custom made',
        domainDesc: 'From day one',
        hostingDesc: '99.9% uptime',
        sslDesc: 'Active certificate',
        maintenanceDesc: 'Updates included',
        supportDesc: 'Real people',
        word1: 'CREATIVE',
        word2: 'CONNECTED',
        word3: 'FAST',
        word4: 'SECURE',
        word5: 'Always<br>on',
        word6: 'SUPPORTED',
        outro: 'Everything<br>connected.'
      },
      transformation: {
        heading: 'Without SiteFlow and with SiteFlow',
        without: 'WITHOUT SITEFLOW',
        chaos: 'EVERYTHING SEPARATE.',
        slow: 'SLOW',
        old: 'OUTDATED',
        noSupport: 'NO SUPPORT',
        separate: 'SEPARATE HOSTING',
        problems: 'PROBLEMS',
        with: 'WITH SITEFLOW',
        resolved: 'EVERYTHING CONNECTED.',
        fast: 'FAST',
        secure: 'SECURE',
        ...
        noBackup: 'NO BACKUPS',
        adv1: 'Loads in under 2 seconds',
        adv2: 'Custom design, no templates',
        adv3: 'Hosting and domain included',
        adv4: 'SSL, backups and monitoring',
        adv5: 'Monthly updates',
        adv6: 'Real support that answers'
      },
      portfolio: {
        title: 'Work made to<br><span>get noticed.</span>',
        sub: 'Real projects, published and live. Open them and see for yourself.',
        visit: 'Visit site',
        t1: 'QR PLATFORM',
        t2: 'E-COMMERCE',
        t3: 'SERVICES SITE',
        ...
        p4: 'GO Solutions',
        p5: 'Kannabyte',
        d1: 'QR menu, live floor and kitchen connected in a single panel for restaurants.',
        d2: 'Body jewellery catalogue with cart and direct WhatsApp ordering.',
        d3: 'Home healthcare in Medellín: services, coverage and direct WhatsApp contact.',
        d4: 'Corporate site for custom software, with services, products and quote requests.',
        d5: 'B2B medicinal export site: products, quality, licenses and commercial contact.'
      },
      benefits: {
        eyebrow: 'The problem',
      ...
      contact: {
        eyebrow: 'Contact',
        title: 'Shall we make something<br><span>incredible?</span>',
        sub: 'Tell us what your business needs.',
      ...
      footer: {
        ...
        c3: 'Projects',
        c4: 'FAQ',
        copy: '© 2026 SiteFlowCol. All rights reserved.',
        legal: 'Legal notice',
        privacy: 'Privacy'
      },
      wa: {
    ...
    de: {
      ...
      hero: {
        ...
        badge: 'Design · Domain · Hosting · Wartung',
        title1: 'Ihr Unternehmen verdient',
        title2: 'eine Website, die für Sie verkauft.',
        sub: 'Wir gestalten, veröffentlichen und pflegen Ihre Website. Sie kümmern sich um Ihr Geschäft. Wir um den Rest.',
        ctaWa: 'Ich möchte meine Website',
        ctaPlans: 'Projekte ansehen',
      ...
      sequence: {
        web: 'EINE WEBSITE.',
        everything: 'ALLES, WAS SIE BRAUCHT.',
        connected: 'ALLES VERBUNDEN.',
        onePlace: 'ALLES AN EINEM ORT.',
        play: 'Animation abspielen',
        stop: 'Stopp'
      },
      included: {
        title: 'Eine Website.<br><span>Alles inklusive.</span>',
        sub: 'Eine Lösung verbindet, was zuvor auf mehrere Anbieter verteilt war.',
        core: 'EINE LÖSUNG',
        design: 'DESIGN',
        domain: 'DOMAIN',
        hosting: 'HOSTING',
        maintenance: 'WARTUNG',
        support: 'SUPPORT',
        designDesc: 'Maßgeschneidert',
        domainDesc: 'Ab dem ersten Tag',
        hostingDesc: '99,9% Uptime',
        sslDesc: 'Aktives Zertifikat',
        maintenanceDesc: 'Updates inklusive',
        supportDesc: 'Echte Menschen',
        word1: 'KREATIV',
        word2: 'VERBUNDEN',
        word3: 'SCHNELL',
        word4: 'SICHER',
        word5: 'Immer<br>aktiv',
        word6: 'BEGLEITET',
        outro: 'Alles<br>verbunden.'
      },
      transformation: {
        heading: 'Ohne SiteFlow und mit SiteFlow',
        without: 'OHNE SITEFLOW',
        chaos: 'ALLES GETRENNT.',
        slow: 'LANGSAM',
        old: 'VERALTET',
        noSupport: 'KEIN SUPPORT',
        separate: 'SEPARATES HOSTING',
        problems: 'PROBLEME',
        with: 'MIT SITEFLOW',
        resolved: 'ALLES VERBUNDEN.',
        fast: 'SCHNELL',
        secure: 'SICHER',
        professional: 'PROFESSIONELL',
        maintained: 'GEPFLEGT',
        generic: 'GENERISCHE VORLAGE',
        noBackup: 'KEINE BACKUPS',
        adv1: 'Lädt in unter 2 Sekunden',
        adv2: 'Eigenes Design, keine Vorlagen',
        adv3: 'Hosting und Domain inklusive',
        adv4: 'SSL, Backups und Monitoring',
        adv5: 'Monatliche Updates',
        adv6: 'Echter Support, der antwortet'
      },
      portfolio: {
        title: 'Arbeit, die<br><span>auffällt.</span>',
        sub: 'Echte Projekte, veröffentlicht und live. Öffnen Sie sie und überzeugen Sie sich selbst.',
        visit: 'Website ansehen',
        t1: 'QR-PLATTFORM',
        t2: 'E-COMMERCE',
        t3: 'DIENSTLEISTUNGSSEITE',
        t4: 'UNTERNEHMENSSEITE',
        t5: 'B2B-SEITE',
        p1: 'Menova',
        p2: 'Oasis Piercing',
        p3: 'ASISTMED',
        p4: 'GO Solutions',
        p5: 'Kannabyte',
        d1: 'QR-Karte, Saal und Küche in einem einzigen Panel für Restaurants verbunden.',
        d2: 'Katalog für Körperschmuck mit Warenkorb und Bestellung direkt über WhatsApp.',
        d3: 'Pflege zu Hause in Medellín: Leistungen, Einsatzgebiet und Kontakt per WhatsApp.',
        d4: 'Unternehmensseite für Individualsoftware mit Leistungen, Produkten und Angebot.',
        d5: 'B2B-Seite für medizinische Exporte: Produkte, Qualität, Lizenzen und Kontakt.'
      },
      benefits: {
        eyebrow: 'Das Problem',
      ...
      process: {
        eyebrow: 'Prozess',
        title: 'Von einer Idee<br><span>zu einer lebendigen Website.</span>',
        sub: 'Ein klarer Prozess ohne Überraschungen — damit Sie so schnell wie möglich starten können.',
        s1t: 'Sie erzählen uns Ihre Idee.',
        ...
        s4t: 'Wir veröffentlichen und pflegen Ihre Website.',
        s4p: 'Ihre Website geht live und wir kümmern uns jeden Monat darum, damit sie nie ausfällt.'
      },
      pricing: {
        eyebrow: 'Tarife',
        title: 'Erstellung + Betreuung.<br><span>Ohne Kleingedrucktes.</span>',
        sub: 'Keine verpflichtenden Jahresverträge. Jederzeit kündbar.',
        currencyAria: 'Währung wählen',
        setupPeriod: 'Einmalzahlung',
        includesPlan: 'Im Tarif enthalten',
        maintHeading: 'Wartung',
        maintPeriod: '/Monat',
        maintCustom: '/Monat auf Anfrage',
        period: '/Monat',
      ...
      contact: {
        eyebrow: 'Kontakt',
        title: 'Schaffen wir etwas<br><span>Unglaubliches?</span>',
        sub: 'Erzählen Sie uns, was Ihr Unternehmen braucht.',
      ...
      footer: {
        ...
        c3: 'Projekte',
        c4: 'FAQ',
        copy: '© 2026 SiteFlowCol. Alle Rechte vorbehalten.',
        legal: 'Impressum',
        privacy: 'Datenschutz'
      },
      wa: {
  ...
  async function init() {
    ...
    initPromise = (async () => {
      ...
      if (!manualSelection && geoLang !== lang) {
        lang = geoLang;
        syncLangButtons();
        moveLangIndicators(false);
        applyContent(false);
